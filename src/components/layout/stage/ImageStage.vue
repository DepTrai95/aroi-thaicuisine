    ...
    <div class="img-container">
      <div class="img-container--element">
        <picture>
          ...
          <img src="../../../assets/img/pad-thai.webp" width="400" height="600" alt="" loading="lazy">
        </picture>
      </div>
      <div class="img-container--element">
        <picture>
          <source
            ...
            sizes="(max-width: 599px) 300px, 600px">
          <img src="../../../assets/img/red-curry.webp" width="400" height="600" alt="" loading="lazy">
        </picture>
      </div>
      <div class="img-container--element">
        <picture>
          <source
            ...
            sizes="(max-width: 599px) 300px, 600px">
          <img src="../../../assets/img/crispy-duck.webp" width="400" height="600" alt="" loading="lazy">
        </picture>
      </div>
    </div>
  </section>
